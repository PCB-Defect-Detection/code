...
con = pymysql.connect(host="192.168.31.10",user="root1",password="0000",port=3306,db="pcb",charset='utf8')
cur = con.cursor()
...
coco_json = os.path.join(base_dir, "coco_format_final_v2.json")
...
class MyWindow(QMainWindow):
    ...
    def check_login(self, user_id, user_pw):
        try:
            conn = pymysql.connect(host='192.168.31.10', user='root1', password='0000', db='pcb', charset='utf8')
            cur = conn.cursor()
...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.thread = video(predictor,"http://192.168.31.2", True)
        ...
        font = QFont()
        font.setPointSize(25)  # 원하는 글자 크기로 설정
        self.default_setting.setFont(font)
        self.default_setting.adjustSize()
        self.default_setting.move(110, 80)
        ...
        self.led_setting.setFont(font_1)
        self.led_setting.adjustSize()
        self.led_setting.move(190,170)

        self.led_input = QTextEdit(self.setting)
        self.led_input.setObjectName(u"led_input")
        self.led_input.setGeometry(QRect(380, 170, 171, 41))

        self.led_slider = QSlider(self.setting)
        self.led_slider.setObjectName(u"led_slider")
        self.led_slider.setGeometry(QRect(600, 180, 160, 22))
        ...
        self.led_button.setGeometry(QRect(810, 180, 160, 22))
        ...
        self.mot_setting.setFont(font_1)
        self.mot_setting.adjustSize()
        self.mot_setting.move(190, 260)
        self.mot_slider = QSlider(self.setting)
        self.mot_slider.setObjectName(u"mot_slider")
        self.mot_slider.setGeometry(QRect(600, 270, 160, 22))
        ...
        self.mot_button.setGeometry(QRect(810, 270, 160, 22))
        ...
        self.mot_input.setGeometry(QRect(380, 260, 171, 41))
        ...
        self.update_btn.setGeometry(QRect(510, 570, 160, 22))
        ...
        self.update_bar.setGeometry(QRect(460,500,300,20))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"PCB Inspection", None))
    ...
    def timer(self):
        try:
            while True:
                ...
                elif "dis" in response.decode():
                    print(response.decode())
                elif "distance" in response.decode():
                    print(response.decode())
...
class video(QThread):
    ...
    def run(self):
        cap = cv2.VideoCapture(1)  # 웹캠 인덱스 0 사용
        cap.set(cv2.CAP_PROP_FRAME_WIDTH, 1024)  # 해상도 설정
